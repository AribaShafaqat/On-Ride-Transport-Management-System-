...
function fetchPendingDriverRequests() {
    fetch('https://saber-windy-nape.glitch.me/driver/api/pending-drivers')
...
function approveDriver(driverId, vehicleRegNumber) {
    fetch('https://saber-windy-nape.glitch.me/driver/api/approve-driver', {
        method: 'POST',
...
function rejectDriver(driverId, vehicleRegNumber) {
    fetch('https://saber-windy-nape.glitch.me/driver/api/reject-driver', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            driver_id: driverId,
