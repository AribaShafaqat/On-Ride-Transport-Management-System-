...
const socket = new WebSocket('wss://saber-windy-nape.glitch.me/');
...
function loadAreas() {
    ...
    fetch('https://saber-windy-nape.glitch.me/get-area/areas')
...
function fetchFilteredVehicles() {
    ...
    const url = `https://saber-windy-nape.glitch.me/real/all-vehicles?type=${vehicleFilter}&status=${statusFilter}&area=${areaFilter}`;
